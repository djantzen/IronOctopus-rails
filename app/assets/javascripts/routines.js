...
//        .selectable({filter: "div.new-activity-set-form"}); // make sure not to mark every child as selected
     ...
     */
    $("#activity-list li.activity").each(function() {
        var facet_target_superkey = generate_facet_key($(this).find("span.faceting-control"), true);        
        ...
        $(this).find(".activity-set-form-template .clone-activity-set-button").click(function() {
          ...
          original.find("select").each(function() { // copy over selected attributes
    ...
    var update_facet_filtered_activities = function(restrict_results) {
      ...
      var facet_key = new RegExp(generate_facet_key($("#activity-facets-panel div.facet-selected span.faceting-control"), false));
    ...
    $("#activity-facets-panel div.facet").click(function() {
      var facet_name = $(this).find("span.faceting-control").text().trim();
